    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="alert alert-warning mb-6">
        ...
        <div>
          ...
          <div className="text-sm">
            The current probabilities shown are incorrect.
            <a
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-lg opacity-80">
          Tracking prediction markets and forecasts on Iran's geopolitical
          developments
        </p>
        {lastUpdate.timestamp && (
          <p className="text-sm opacity-60 mt-2">
            Last updated {formatDistanceToNow(new Date(lastUpdate.timestamp))}{" "}
            ago
            {!lastUpdate.success && (
      ...
      <div className="not-prose mt-12 text-center opacity-70">
        <p>
          Data from: Adjacent News • Metaculus • Kalshi • Polymarket • PredictIt
          • Manifold Markets
        </p>
      </div>
      ...
      <div className="not-prose mt-8 text-center pb-4">
        <p className="text-lg">
          ...
          to support similar projects, please purchase a subscription{" "}
          <a
