...
export const CALIFORNIA_ESTIMATES: Estimate[] = [
  ...
  },
  {
    ...
    method:
      "[[base|Base rate 2.5–3% a year (Fig. 5B)]] times [[mult|an El Niño multiplier of ×2–5]] gives 5–15%; the headline takes about ×3, which is also the middle of the three readings on this page: the unconditioned ~3%, this one, and Belikewater's 10–13%. [[belikewater|Belikewater]] [[q8|argues for 10–13%]] by taking [[q5|the 7-of-8 finding]] at face value against [[mult|how rare such winters are]]. Claude F5.1 sits lower because the model's own El Niño frequency is unknown and [[mult|the instrumental record suggests ×2.4]]. Until 18 Sep this tile showed the unconditioned ~3%.",
    quotes: [
